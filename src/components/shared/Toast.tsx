...
import { Toast as Props } from 'interfaces/toast';
          ...
          <div className="flex flex-col justify-center w-full p-3">
            <div className="flex items-start">
              ...
              <div className="ml-2 w-0 flex-1 pt-0.5 overflow-hidden">
                ...
                {image ? (
                  <img src={image} alt="toast" className="mt-2 rounded-md" />
                ) : null}
              </div>
            </div>
          </div>
          <div className="flex border-l border-gray-200  group">
            ...
            >
              {closeText ? (
                ...
                <svg
                  className="text-gray-400 fill-current w-7 h-7 group-hover:text-gray-500 "
